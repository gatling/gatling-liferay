...
public class LinkUsecaseRequestWrapper implements LinkUsecaseRequest,
	...
	*/
	...
	/**
	* Returns the request ID of this link usecase request.
	*
	* @return the request ID of this link usecase request
	*/
	@Override
	public long getRequestId() {
		return _linkUsecaseRequest.getRequestId();
	}

	/**
	* Sets the request ID of this link usecase request.
	*
	* @param requestId the request ID of this link usecase request
	*/
	@Override
	public void setRequestId(long requestId) {
		_linkUsecaseRequest.setRequestId(requestId);
	}
