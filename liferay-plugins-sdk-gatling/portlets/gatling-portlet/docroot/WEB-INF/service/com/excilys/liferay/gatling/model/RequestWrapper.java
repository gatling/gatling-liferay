...
public class RequestWrapper implements Request, ModelWrapper<Request> {
	...
	*/
	...
	/**
	* Returns the scenario ID of this request.
	*
	* @return the scenario ID of this request
	*/
	@Override
	public long getScenarioId() {
		return _request.getScenarioId();
	}

	/**
	* Sets the scenario ID of this request.
	*
	* @param scenarioId the scenario ID of this request
	*/
	@Override
	public void setScenarioId(long scenarioId) {
		_request.setScenarioId(scenarioId);
	}
