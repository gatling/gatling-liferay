...
public class LinkUsecaseRequestPersistenceImpl extends BasePersistenceImpl<LinkUsecaseRequest>
	 ...
	 */
	@Override
	public List<LinkUsecaseRequest> findByRequestIdAndUsed(long requestId,
		double weight) throws SystemException {
		return findByRequestIdAndUsed(requestId, weight, QueryUtil.ALL_POS,
	...
	public List<LinkUsecaseRequest> findByRequestIdAndUsed(long requestId,
		...
		return findByRequestIdAndUsed(requestId, weight, start, end, null);
	}
	...
	public List<LinkUsecaseRequest> findByRequestIdAndUsed(long requestId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LinkUsecaseRequest linkUsecaseRequest : list) {
				if ((requestId != linkUsecaseRequest.getRequestId()) ||
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_REQUESTIDANDUSED_REQUESTID_2);
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestIdAndUsed_First(long requestId,
		double weight, OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestIdAndUsed_First(requestId,
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestIdAndUsed_First(long requestId,
		double weight, OrderByComparator orderByComparator)
		throws SystemException {
		List<LinkUsecaseRequest> list = findByRequestIdAndUsed(requestId,
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestIdAndUsed_Last(long requestId,
		double weight, OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestIdAndUsed_Last(requestId,
				weight, orderByComparator);
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestIdAndUsed_Last(long requestId,
		double weight, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByRequestIdAndUsed(requestId, weight);
	...
	public LinkUsecaseRequest[] findByRequestIdAndUsed_PrevAndNext(
		...
		try {
			...
			array[0] = getByRequestIdAndUsed_PrevAndNext(session,
					linkUsecaseRequest, requestId, weight, orderByComparator,
					true);
	...
	protected LinkUsecaseRequest getByRequestIdAndUsed_PrevAndNext(
		Session session, LinkUsecaseRequest linkUsecaseRequest, long requestId,
	...
	public void removeByRequestIdAndUsed(long requestId, double weight)
		...
		for (LinkUsecaseRequest linkUsecaseRequest : findByRequestIdAndUsed(
				requestId, weight, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	public int countByRequestIdAndUsed(long requestId, double weight)
		...
		Object[] finderArgs = new Object[] { requestId, weight };
	...
	private static final String _FINDER_COLUMN_REQUESTIDANDUSED_REQUESTID_2 = "linkUsecaseRequest.requestId = ? AND ";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_REQUESTIDANDRECORDID =
		new FinderPath(LinkUsecaseRequestModelImpl.ENTITY_CACHE_ENABLED,
			LinkUsecaseRequestModelImpl.FINDER_CACHE_ENABLED,
			LinkUsecaseRequestImpl.class,
			...
			LinkUsecaseRequestModelImpl.REQUESTID_COLUMN_BITMASK |
			LinkUsecaseRequestModelImpl.RECORDID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_REQUESTIDANDRECORDID = new FinderPath(LinkUsecaseRequestModelImpl.ENTITY_CACHE_ENABLED,
			LinkUsecaseRequestModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByRequestIdAndrecordId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<LinkUsecaseRequest> findByRequestIdAndrecordId(long requestId,
		long recordId) throws SystemException {
		return findByRequestIdAndrecordId(requestId, recordId,
	...
	@Override
	public List<LinkUsecaseRequest> findByRequestIdAndrecordId(long requestId,
		long recordId, int start, int end) throws SystemException {
		return findByRequestIdAndrecordId(requestId, recordId, start, end, null);
	}
	...
	@Override
	public List<LinkUsecaseRequest> findByRequestIdAndrecordId(long requestId,
		long recordId, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_REQUESTIDANDRECORDID;
			finderArgs = new Object[] { requestId, recordId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_REQUESTIDANDRECORDID;
			finderArgs = new Object[] {
					requestId, recordId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (LinkUsecaseRequest linkUsecaseRequest : list) {
				if ((requestId != linkUsecaseRequest.getRequestId()) ||
						(recordId != linkUsecaseRequest.getRecordId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_REQUESTIDANDRECORDID_REQUESTID_2);

			query.append(_FINDER_COLUMN_REQUESTIDANDRECORDID_RECORDID_2);
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestIdAndrecordId_First(long requestId,
		long recordId, OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestIdAndrecordId_First(requestId,
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestIdAndrecordId_First(
		long requestId, long recordId, OrderByComparator orderByComparator)
		throws SystemException {
		List<LinkUsecaseRequest> list = findByRequestIdAndrecordId(requestId,
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestIdAndrecordId_Last(long requestId,
		long recordId, OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestIdAndrecordId_Last(requestId,
				recordId, orderByComparator);
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestIdAndrecordId_Last(long requestId,
		long recordId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByRequestIdAndrecordId(requestId, recordId);
	 ...
	 */
	@Override
	public LinkUsecaseRequest[] findByRequestIdAndrecordId_PrevAndNext(
		...
		try {
			...
			array[0] = getByRequestIdAndrecordId_PrevAndNext(session,
					linkUsecaseRequest, requestId, recordId, orderByComparator,
					true);

			array[1] = linkUsecaseRequest;

			array[2] = getByRequestIdAndrecordId_PrevAndNext(session,
					linkUsecaseRequest, requestId, recordId, orderByComparator,
					false);
	...
	protected LinkUsecaseRequest getByRequestIdAndrecordId_PrevAndNext(
		Session session, LinkUsecaseRequest linkUsecaseRequest, long requestId,
		long recordId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByRequestIdAndrecordId(long requestId, long recordId)
		throws SystemException {
		for (LinkUsecaseRequest linkUsecaseRequest : findByRequestIdAndrecordId(
				requestId, recordId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(linkUsecaseRequest);
		}
	}
	...
	public int countByRequestIdAndrecordId(long requestId, long recordId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_REQUESTIDANDRECORDID;

		Object[] finderArgs = new Object[] { requestId, recordId };
	...
	private static final String _FINDER_COLUMN_REQUESTIDANDRECORDID_REQUESTID_2 = "linkUsecaseRequest.requestId = ? AND ";
	private static final String _FINDER_COLUMN_REQUESTIDANDRECORDID_RECORDID_2 = "linkUsecaseRequest.recordId = ?";
	 ...
	 */
	@Override
	public List<LinkUsecaseRequest> findByRequestId(long requestId)
		throws SystemException {
		return findByRequestId(requestId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<LinkUsecaseRequest> findByRequestId(long requestId, int start,
	...
	public List<LinkUsecaseRequest> findByRequestId(long requestId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_REQUESTID_REQUESTID_2);
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestId_First(long requestId,
		OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestId_First(requestId,
				orderByComparator);
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestId_First(long requestId,
		OrderByComparator orderByComparator) throws SystemException {
		List<LinkUsecaseRequest> list = findByRequestId(requestId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public LinkUsecaseRequest findByRequestId_Last(long requestId,
		OrderByComparator orderByComparator)
		throws NoSuchLinkUsecaseRequestException, SystemException {
		LinkUsecaseRequest linkUsecaseRequest = fetchByRequestId_Last(requestId,
				orderByComparator);
	 ...
	 */
	@Override
	public LinkUsecaseRequest fetchByRequestId_Last(long requestId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<LinkUsecaseRequest> list = findByRequestId(requestId, count - 1,
	...
	protected LinkUsecaseRequest getByRequestId_PrevAndNext(Session session,
		LinkUsecaseRequest linkUsecaseRequest, long requestId,
	...
	private static final String _FINDER_COLUMN_REQUESTID_REQUESTID_2 = "linkUsecaseRequest.requestId = ?";
	...
	public LinkUsecaseRequest updateImpl(
		...
		if (isNew || !LinkUsecaseRequestModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((linkUsecaseRequestModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_REQUESTIDANDRECORDID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						linkUsecaseRequestModelImpl.getOriginalRequestId(),
						linkUsecaseRequestModelImpl.getOriginalRecordId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_REQUESTIDANDRECORDID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_REQUESTIDANDRECORDID,
					args);

				args = new Object[] {
						linkUsecaseRequestModelImpl.getRequestId(),
						linkUsecaseRequestModelImpl.getRecordId()
					};
			...
			if ((linkUsecaseRequestModelImpl.getColumnBitmask() &
				...
				args = new Object[] { linkUsecaseRequestModelImpl.getRequestId() };
	...
	protected LinkUsecaseRequest toUnwrappedModel(
		...
		linkUsecaseRequestImpl.setRequestId(linkUsecaseRequest.getRequestId());
