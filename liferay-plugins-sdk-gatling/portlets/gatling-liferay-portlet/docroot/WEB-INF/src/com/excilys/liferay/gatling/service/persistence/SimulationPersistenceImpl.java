...
public class SimulationPersistenceImpl extends BasePersistenceImpl<Simulation>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_VARIABLENAME =
		new FinderPath(SimulationModelImpl.ENTITY_CACHE_ENABLED,
			...
			SimulationModelImpl.VARIABLENAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_VARIABLENAME = new FinderPath(SimulationModelImpl.ENTITY_CACHE_ENABLED,
			SimulationModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<Simulation> findByVariableName(String variableName)
		...
		return findByVariableName(variableName, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public List<Simulation> findByVariableName(String variableName, int start,
		int end) throws SystemException {
		return findByVariableName(variableName, start, end, null);
	}
	...
	public List<Simulation> findByVariableName(String variableName, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { variableName };
		}
		else {
		...
		if ((list != null) && !list.isEmpty()) {
			for (Simulation simulation : list) {
				if (!Validator.equals(variableName, simulation.getVariableName())) {
					list = null;
	 ...
	 */
	@Override
	public Simulation findByVariableName_First(String variableName,
		OrderByComparator orderByComparator)
		throws NoSuchSimulationException, SystemException {
		Simulation simulation = fetchByVariableName_First(variableName,
				orderByComparator);
	 ...
	 */
	@Override
	public Simulation fetchByVariableName_First(String variableName,
		OrderByComparator orderByComparator) throws SystemException {
		List<Simulation> list = findByVariableName(variableName, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Simulation findByVariableName_Last(String variableName,
		OrderByComparator orderByComparator)
		throws NoSuchSimulationException, SystemException {
		Simulation simulation = fetchByVariableName_Last(variableName,
				orderByComparator);
	 ...
	 */
	@Override
	public Simulation fetchByVariableName_Last(String variableName,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByVariableName(variableName);

		if (count == 0) {
			return null;
		}

		List<Simulation> list = findByVariableName(variableName, count - 1,
	 ...
	 */
	@Override
	public Simulation[] findByVariableName_PrevAndNext(long simulation_id,
		String variableName, OrderByComparator orderByComparator)
		throws NoSuchSimulationException, SystemException {
		Simulation simulation = findByPrimaryKey(simulation_id);
		...
		try {
			...
			array[0] = getByVariableName_PrevAndNext(session, simulation,
					variableName, orderByComparator, true);

			array[1] = simulation;

			array[2] = getByVariableName_PrevAndNext(session, simulation,
					variableName, orderByComparator, false);
	...
	protected Simulation getByVariableName_PrevAndNext(Session session,
		Simulation simulation, String variableName,
	 ...
	 */
	@Override
	public void removeByVariableName(String variableName)
		throws SystemException {
		for (Simulation simulation : findByVariableName(variableName,
	 ...
	 */
	@Override
	public int countByVariableName(String variableName)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_VARIABLENAME;

		Object[] finderArgs = new Object[] { variableName };
	...
	private static final String _FINDER_COLUMN_VARIABLENAME_VARIABLENAME_1 = "simulation.variableName IS NULL";
	private static final String _FINDER_COLUMN_VARIABLENAME_VARIABLENAME_2 = "simulation.variableName = ?";
	private static final String _FINDER_COLUMN_VARIABLENAME_VARIABLENAME_3 = "(simulation.variableName IS NULL OR simulation.variableName = '')";
		...
		if (isNew || !SimulationModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((simulationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						simulationModelImpl.getOriginalVariableName()
					};
				...
				args = new Object[] { simulationModelImpl.getVariableName() };
	...
	protected Simulation toUnwrappedModel(Simulation simulation) {
		...
		simulationImpl.setVariableName(simulation.getVariableName());
