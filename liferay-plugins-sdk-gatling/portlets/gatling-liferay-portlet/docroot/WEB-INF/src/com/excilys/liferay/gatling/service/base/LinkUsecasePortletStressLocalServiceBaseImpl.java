...
import com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalService;
import com.excilys.liferay.gatling.service.persistence.LinkUsecasePortletStressPersistence;
import com.excilys.liferay.gatling.service.persistence.PortletStressPersistence;
...
/**
 * Provides the base implementation for the link usecase portlet stress local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.excilys.liferay.gatling.service.impl.LinkUsecasePortletStressLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.excilys.liferay.gatling.service.impl.LinkUsecasePortletStressLocalServiceImpl
 * @see com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalServiceUtil
 * @generated
 */
public abstract class LinkUsecasePortletStressLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LinkUsecasePortletStressLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalServiceUtil} to access the link usecase portlet stress local service.
	 */
	...
	@Override
	public LinkUsecasePortletStress addLinkUsecasePortletStress(
		LinkUsecasePortletStress linkUsecasePortletStress)
		throws SystemException {
		linkUsecasePortletStress.setNew(true);

		return linkUsecasePortletStressPersistence.update(linkUsecasePortletStress);
	}
	 ...
	 */
	@Override
	public LinkUsecasePortletStress createLinkUsecasePortletStress(
		long linkUsecasePortletStressId) {
		return linkUsecasePortletStressPersistence.create(linkUsecasePortletStressId);
	}
	...
	@Override
	public LinkUsecasePortletStress deleteLinkUsecasePortletStress(
		long linkUsecasePortletStressId)
		throws PortalException, SystemException {
		return linkUsecasePortletStressPersistence.remove(linkUsecasePortletStressId);
	}
	...
	public LinkUsecasePortletStress deleteLinkUsecasePortletStress(
		LinkUsecasePortletStress linkUsecasePortletStress)
		throws SystemException {
		return linkUsecasePortletStressPersistence.remove(linkUsecasePortletStress);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LinkUsecasePortletStress.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return linkUsecasePortletStressPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return linkUsecasePortletStressPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LinkUsecasePortletStress fetchLinkUsecasePortletStress(
		long linkUsecasePortletStressId) throws SystemException {
		return linkUsecasePortletStressPersistence.fetchByPrimaryKey(linkUsecasePortletStressId);
	}
	 ...
	 */
	@Override
	public LinkUsecasePortletStress getLinkUsecasePortletStress(
		long linkUsecasePortletStressId)
		throws PortalException, SystemException {
		return linkUsecasePortletStressPersistence.findByPrimaryKey(linkUsecasePortletStressId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return linkUsecasePortletStressPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LinkUsecasePortletStress> getLinkUsecasePortletStresses(
		int start, int end) throws SystemException {
		return linkUsecasePortletStressPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLinkUsecasePortletStressesCount() throws SystemException {
		return linkUsecasePortletStressPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LinkUsecasePortletStress updateLinkUsecasePortletStress(
		LinkUsecasePortletStress linkUsecasePortletStress)
		throws SystemException {
		return linkUsecasePortletStressPersistence.update(linkUsecasePortletStress);
	}
	...
	/**
	 * Returns the link usecase portlet stress local service.
	 *
	 * @return the link usecase portlet stress local service
	 */
	public com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalService getLinkUsecasePortletStressLocalService() {
		return linkUsecasePortletStressLocalService;
	}

	/**
	 * Sets the link usecase portlet stress local service.
	 *
	 * @param linkUsecasePortletStressLocalService the link usecase portlet stress local service
	 */
	public void setLinkUsecasePortletStressLocalService(
		com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalService linkUsecasePortletStressLocalService) {
		this.linkUsecasePortletStressLocalService = linkUsecasePortletStressLocalService;
	}

	/**
	 * Returns the link usecase portlet stress persistence.
	 *
	 * @return the link usecase portlet stress persistence
	 */
	public LinkUsecasePortletStressPersistence getLinkUsecasePortletStressPersistence() {
		return linkUsecasePortletStressPersistence;
	}

	/**
	 * Sets the link usecase portlet stress persistence.
	 *
	 * @param linkUsecasePortletStressPersistence the link usecase portlet stress persistence
	 */
	public void setLinkUsecasePortletStressPersistence(
		LinkUsecasePortletStressPersistence linkUsecasePortletStressPersistence) {
		this.linkUsecasePortletStressPersistence = linkUsecasePortletStressPersistence;
	}

	/**
	 * Returns the portlet stress remote service.
	 *
	 * @return the portlet stress remote service
	 */
	public com.excilys.liferay.gatling.service.PortletStressService getPortletStressService() {
		return portletStressService;
	}

	/**
	 * Sets the portlet stress remote service.
	 *
	 * @param portletStressService the portlet stress remote service
	 */
	public void setPortletStressService(
		com.excilys.liferay.gatling.service.PortletStressService portletStressService) {
		this.portletStressService = portletStressService;
	}

	/**
	 * Returns the portlet stress persistence.
	 *
	 * @return the portlet stress persistence
	 */
	public PortletStressPersistence getPortletStressPersistence() {
		return portletStressPersistence;
	}

	/**
	 * Sets the portlet stress persistence.
	 *
	 * @param portletStressPersistence the portlet stress persistence
	 */
	public void setPortletStressPersistence(
		PortletStressPersistence portletStressPersistence) {
		this.portletStressPersistence = portletStressPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.excilys.liferay.gatling.model.LinkUsecasePortletStress",
			linkUsecasePortletStressLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = linkUsecasePortletStressPersistence.getDataSource();
	...
	@BeanReference(type = com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalService.class)
	protected com.excilys.liferay.gatling.service.LinkUsecasePortletStressLocalService linkUsecasePortletStressLocalService;
	@BeanReference(type = LinkUsecasePortletStressPersistence.class)
	protected LinkUsecasePortletStressPersistence linkUsecasePortletStressPersistence;
	@BeanReference(type = com.excilys.liferay.gatling.service.PortletStressService.class)
	protected com.excilys.liferay.gatling.service.PortletStressService portletStressService;
	@BeanReference(type = PortletStressPersistence.class)
	protected PortletStressPersistence portletStressPersistence;
	...
	private LinkUsecasePortletStressLocalServiceClpInvoker _clpInvoker = new LinkUsecasePortletStressLocalServiceClpInvoker();
}