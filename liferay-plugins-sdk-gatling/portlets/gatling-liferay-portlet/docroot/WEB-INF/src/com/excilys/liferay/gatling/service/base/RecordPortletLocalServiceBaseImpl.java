...
import com.excilys.liferay.gatling.service.RecordPortletLocalService;
...
/**
 * Provides the base implementation for the record portlet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.excilys.liferay.gatling.service.impl.RecordPortletLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RecordPortletLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecordPortletLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.excilys.liferay.gatling.service.RecordPortletLocalServiceUtil} to access the record portlet local service.
	 */
	...
	@Override
	public RecordPortlet addRecordPortlet(RecordPortlet recordPortlet)
		throws SystemException {
		recordPortlet.setNew(true);

		return recordPortletPersistence.update(recordPortlet);
	}
	 ...
	 */
	@Override
	public RecordPortlet createRecordPortlet(long recordPortletId) {
		return recordPortletPersistence.create(recordPortletId);
	}
	...
	@Override
	public RecordPortlet deleteRecordPortlet(long recordPortletId)
		throws PortalException, SystemException {
		return recordPortletPersistence.remove(recordPortletId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RecordPortlet deleteRecordPortlet(RecordPortlet recordPortlet)
		throws SystemException {
		return recordPortletPersistence.remove(recordPortlet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RecordPortlet.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recordPortletPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recordPortletPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RecordPortlet fetchRecordPortlet(long recordPortletId)
		throws SystemException {
		return recordPortletPersistence.fetchByPrimaryKey(recordPortletId);
	}
	 ...
	 */
	@Override
	public RecordPortlet getRecordPortlet(long recordPortletId)
		throws PortalException, SystemException {
		return recordPortletPersistence.findByPrimaryKey(recordPortletId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recordPortletPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RecordPortlet> getRecordPortlets(int start, int end)
		throws SystemException {
		return recordPortletPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRecordPortletsCount() throws SystemException {
		return recordPortletPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RecordPortlet updateRecordPortlet(RecordPortlet recordPortlet)
		throws SystemException {
		return recordPortletPersistence.update(recordPortlet);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.excilys.liferay.gatling.model.RecordPortlet",
			recordPortletLocalService);
	}
	...
	private RecordPortletLocalServiceClpInvoker _clpInvoker = new RecordPortletLocalServiceClpInvoker();
}