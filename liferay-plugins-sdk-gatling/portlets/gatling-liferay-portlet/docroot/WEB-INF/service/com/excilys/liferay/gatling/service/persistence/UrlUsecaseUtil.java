...
/**
 * The persistence utility for the url usecase service. This utility wraps {@link UrlUsecasePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class UrlUsecaseUtil {
	 ...
	 */
	public static void clearCache(UrlUsecase urlUsecase) {
		getPersistence().clearCache(urlUsecase);
	}
	 ...
	 */
	public static List<UrlUsecase> findWithDynamicQuery(
	 ...
	 */
	public static UrlUsecase update(UrlUsecase urlUsecase)
		throws SystemException {
		return getPersistence().update(urlUsecase);
	}
	...
	public static UrlUsecase update(UrlUsecase urlUsecase,
		...
		return getPersistence().update(urlUsecase, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(urlUsecase);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(urlUsecases);
	}
	...
	*/
	public static com.excilys.liferay.gatling.model.UrlUsecase create(
		long urlUsecaseId) {
		return getPersistence().create(urlUsecaseId);
	}
	...
	*/
	public static com.excilys.liferay.gatling.model.UrlUsecase remove(
		long urlUsecaseId)
		throws com.excilys.liferay.gatling.NoSuchUrlUsecaseException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(urlUsecaseId);
	}

	public static com.excilys.liferay.gatling.model.UrlUsecase updateImpl(
		com.excilys.liferay.gatling.model.UrlUsecase urlUsecase)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(urlUsecase);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.excilys.liferay.gatling.model.UrlUsecase findByPrimaryKey(
		long urlUsecaseId)
		throws com.excilys.liferay.gatling.NoSuchUrlUsecaseException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(urlUsecaseId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.excilys.liferay.gatling.model.UrlUsecase fetchByPrimaryKey(
		long urlUsecaseId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(urlUsecaseId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.excilys.liferay.gatling.model.UrlUsecase> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static UrlUsecasePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (UrlUsecasePersistence)PortletBeanLocatorUtil.locate(com.excilys.liferay.gatling.service.ClpSerializer.getServletContextName(),
					UrlUsecasePersistence.class.getName());

			ReferenceRegistry.registerReference(UrlUsecaseUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(UrlUsecasePersistence persistence) {
	}

	private static UrlUsecasePersistence _persistence;
}