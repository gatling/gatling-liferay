...
/**
 * Provides the local service interface for UrlUsecase. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UrlUsecaseLocalServiceUtil
...
public interface UrlUsecaseLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UrlUsecaseLocalServiceUtil} to access the url usecase local service. Add custom service methods to {@link com.excilys.liferay.gatling.service.impl.UrlUsecaseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
