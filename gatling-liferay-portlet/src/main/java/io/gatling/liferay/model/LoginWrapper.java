...
public class LoginWrapper implements Login, ModelWrapper<Login> {
    ...
    */
    ...
    @Override
    public int compareTo(io.gatling.liferay.model.Login login) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<io.gatling.liferay.model.Login> toCacheModel() {
        return _login.toCacheModel();
    }

    @Override
    public io.gatling.liferay.model.Login toEscapedModel() {
        return new LoginWrapper(_login.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.Login toUnescapedModel() {
