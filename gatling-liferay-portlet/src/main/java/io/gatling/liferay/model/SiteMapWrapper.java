...
public class SiteMapWrapper implements SiteMap, ModelWrapper<SiteMap> {
    ...
    */
    ...
    @Override
    public int compareTo(io.gatling.liferay.model.SiteMap siteMap) {
    ...
    @Override
    public io.gatling.liferay.model.SiteMap toEscapedModel() {
        return new SiteMapWrapper(_siteMap.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.SiteMap toUnescapedModel() {
