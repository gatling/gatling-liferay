...
public class RequestWrapper implements Request, ModelWrapper<Request> {
    ...
    */
    ...
    @Override
    public int compareTo(io.gatling.liferay.model.Request request) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<io.gatling.liferay.model.Request> toCacheModel() {
        return _request.toCacheModel();
    }

    @Override
    public io.gatling.liferay.model.Request toEscapedModel() {
        return new RequestWrapper(_request.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.Request toUnescapedModel() {
