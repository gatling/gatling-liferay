...
public class ScenarioWrapper implements Scenario, ModelWrapper<Scenario> {
    ...
    */
    ...
    @Override
    public int compareTo(io.gatling.liferay.model.Scenario scenario) {
    ...
    @Override
    public io.gatling.liferay.model.Scenario toEscapedModel() {
        return new ScenarioWrapper(_scenario.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.Scenario toUnescapedModel() {
