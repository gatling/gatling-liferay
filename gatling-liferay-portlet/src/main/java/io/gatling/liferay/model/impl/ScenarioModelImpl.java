 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link io.gatling.liferay.model.ScenarioModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ScenarioImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ScenarioImpl
 * @see io.gatling.liferay.model.Scenario
 * @see io.gatling.liferay.model.ScenarioModel
 * @generated
 */
public class ScenarioModelImpl extends BaseModelImpl<Scenario>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a scenario model instance should use the {@link io.gatling.liferay.model.Scenario} interface instead.
     */
