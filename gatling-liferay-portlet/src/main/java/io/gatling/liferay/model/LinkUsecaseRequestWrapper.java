...
public class LinkUsecaseRequestWrapper implements LinkUsecaseRequest,
    ...
    */
    ...
    @Override
    public com.liferay.portal.model.CacheModel<io.gatling.liferay.model.LinkUsecaseRequest> toCacheModel() {
        return _linkUsecaseRequest.toCacheModel();
    }

    @Override
    public io.gatling.liferay.model.LinkUsecaseRequest toEscapedModel() {
        return new LinkUsecaseRequestWrapper(_linkUsecaseRequest.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.LinkUsecaseRequest toUnescapedModel() {
