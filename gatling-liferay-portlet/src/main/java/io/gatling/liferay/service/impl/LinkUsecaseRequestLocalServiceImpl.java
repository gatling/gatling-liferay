...
import io.gatling.liferay.service.base.LinkUsecaseRequestLocalServiceBaseImpl;
import io.gatling.liferay.validator.LinkUsecaseRequestValidator;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link io.gatling.liferay.service.LinkUsecaseRequestLocalService} interface.
 *
 * <p>
 ...
 * @see io.gatling.liferay.service.LinkUsecaseRequestLocalServiceUtil
 */
...
extends LinkUsecaseRequestLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this interface directly. Always use {@link io.gatling.liferay.service.LinkUsecaseRequestLocalServiceUtil} to access the link usecase request local service.
	 */
