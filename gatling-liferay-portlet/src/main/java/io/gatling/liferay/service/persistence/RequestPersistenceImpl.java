...
import io.gatling.liferay.NoSuchRequestException;
import io.gatling.liferay.model.Request;
import io.gatling.liferay.model.impl.RequestImpl;
import io.gatling.liferay.model.impl.RequestModelImpl;
...
public class RequestPersistenceImpl extends BasePersistenceImpl<Request>
    ...
    @Override
    public Request updateImpl(io.gatling.liferay.model.Request request)
        throws SystemException {
        request = toUnwrappedModel(request);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.io.gatling.liferay.model.Request")));
