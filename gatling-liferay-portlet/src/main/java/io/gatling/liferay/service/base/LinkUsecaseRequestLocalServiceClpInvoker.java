...
public class LinkUsecaseRequestLocalServiceClpInvoker {
    ...
    public LinkUsecaseRequestLocalServiceClpInvoker() {
        ...
        _methodName82 = "saveLinkUseCase";

        _methodParameterTypes82 = new String[] {
                "long", "long", "long", "double", "boolean"
            };

        _methodName83 = "findByRecordAndRequest";

        _methodParameterTypes83 = new String[] { "long", "long" };

        _methodName84 = "countByRequestIdAndUsed";

        _methodParameterTypes84 = new String[] { "long" };

        _methodName85 = "findByRequestIdAndUsed";

        _methodParameterTypes85 = new String[] { "long" };

        _methodName86 = "countByRequestId";

        _methodParameterTypes86 = new String[] { "long" };

        _methodName87 = "findByRequestId";

        _methodParameterTypes87 = new String[] { "long" };

        _methodName88 = "removeByRequestId";

        _methodParameterTypes88 = new String[] { "long" };

        _methodName89 = "removeByRecordId";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return LinkUsecaseRequestLocalServiceUtil.addLinkUsecaseRequest((io.gatling.liferay.model.LinkUsecaseRequest) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return LinkUsecaseRequestLocalServiceUtil.deleteLinkUsecaseRequest((io.gatling.liferay.model.LinkUsecaseRequest) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return LinkUsecaseRequestLocalServiceUtil.updateLinkUsecaseRequest((io.gatling.liferay.model.LinkUsecaseRequest) arguments[0]);
        }
