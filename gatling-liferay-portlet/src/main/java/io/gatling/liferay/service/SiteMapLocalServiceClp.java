...
public class SiteMapLocalServiceClp implements SiteMapLocalService {
    ...
    public java.util.List<io.gatling.liferay.model.SiteMap> getSiteMaps(
        ...
        return (java.util.List<io.gatling.liferay.model.SiteMap>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public io.gatling.liferay.model.SiteMap findByName(java.lang.String name)
        ...
        try {
            ...
            if (t instanceof io.gatling.liferay.NoSuchRecordException) {
                throw (io.gatling.liferay.NoSuchRecordException) t;
            }

            if (t instanceof io.gatling.liferay.NoSuchSiteMapException) {
                throw (io.gatling.liferay.NoSuchSiteMapException) t;
            }
