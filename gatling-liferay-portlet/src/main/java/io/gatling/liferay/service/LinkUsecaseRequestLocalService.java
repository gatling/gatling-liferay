...
public interface LinkUsecaseRequestLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LinkUsecaseRequestLocalServiceUtil} to access the link usecase request local service. Add custom service methods to {@link io.gatling.liferay.service.impl.LinkUsecaseRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public io.gatling.liferay.model.LinkUsecaseRequest addLinkUsecaseRequest(
    ...
    */
    public io.gatling.liferay.model.LinkUsecaseRequest createLinkUsecaseRequest(
    ...
    */
    ...
    public io.gatling.liferay.model.LinkUsecaseRequest deleteLinkUsecaseRequest(
        long linkUsecaseRequestId)
    ...
    */
    ...
    public io.gatling.liferay.model.LinkUsecaseRequest fetchLinkUsecaseRequest(
        long linkUsecaseRequestId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public io.gatling.liferay.model.LinkUsecaseRequest getLinkUsecaseRequest(
        long linkUsecaseRequestId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<io.gatling.liferay.model.LinkUsecaseRequest> getLinkUsecaseRequests(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public io.gatling.liferay.model.LinkUsecaseRequest updateLinkUsecaseRequest(
        io.gatling.liferay.model.LinkUsecaseRequest linkUsecaseRequest)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    public java.util.List<io.gatling.liferay.model.LinkUsecaseRequest> findByRecordAndRequest(
