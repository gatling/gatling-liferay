...
public class LoginLocalServiceClp implements LoginLocalService {
    ...
    public java.util.List<io.gatling.liferay.model.Login> getLogins(int start,
        ...
        return (java.util.List<io.gatling.liferay.model.Login>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public io.gatling.liferay.model.Login findByName(java.lang.String name)
        ...
        try {
            ...
            if (t instanceof io.gatling.liferay.NoSuchLoginException) {
                throw (io.gatling.liferay.NoSuchLoginException) t;
            }
