...
import com.excilys.liferay.gatling.service.FormParamLocalService;
...
/**
 * Provides the base implementation for the form param local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.excilys.liferay.gatling.service.impl.FormParamLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FormParamLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements FormParamLocalService, IdentifiableBean {
    ...
    private FormParamLocalServiceClpInvoker _clpInvoker = new FormParamLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.excilys.liferay.gatling.service.FormParamLocalServiceUtil} to access the form param local service.
     */
    ...
    @Override
    public FormParam addFormParam(FormParam formParam)
        throws SystemException {
        formParam.setNew(true);

        return formParamPersistence.update(formParam);
    }
     ...
     */
    @Override
    public FormParam createFormParam(long formParamId) {
        return formParamPersistence.create(formParamId);
    }
    ...
    @Override
    public FormParam deleteFormParam(long formParamId)
        throws PortalException, SystemException {
        return formParamPersistence.remove(formParamId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FormParam deleteFormParam(FormParam formParam)
        throws SystemException {
        return formParamPersistence.remove(formParam);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FormParam.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return formParamPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return formParamPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public FormParam fetchFormParam(long formParamId) throws SystemException {
        return formParamPersistence.fetchByPrimaryKey(formParamId);
    }
     ...
     */
    @Override
    public FormParam getFormParam(long formParamId)
        throws PortalException, SystemException {
        return formParamPersistence.findByPrimaryKey(formParamId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return formParamPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<FormParam> getFormParams(int start, int end)
        throws SystemException {
        return formParamPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getFormParamsCount() throws SystemException {
        return formParamPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FormParam updateFormParam(FormParam formParam)
        throws SystemException {
        return formParamPersistence.update(formParam);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.excilys.liferay.gatling.model.FormParam",
            formParamLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = formParamPersistence.getDataSource();
