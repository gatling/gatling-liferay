...
import com.excilys.liferay.gatling.service.LoginLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.excilys.liferay.gatling.service.impl.LoginLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LoginLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LoginLocalService, IdentifiableBean {
    ...
    private LoginLocalServiceClpInvoker _clpInvoker = new LoginLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.excilys.liferay.gatling.service.LoginLocalServiceUtil} to access the login local service.
     */
    ...
    @Override
    public Login addLogin(Login login) throws SystemException {
        login.setNew(true);
     ...
     */
    @Override
    public Login createLogin(long userId) {
        return loginPersistence.create(userId);
    }
    ...
    @Override
    public Login deleteLogin(long userId)
        throws PortalException, SystemException {
        return loginPersistence.remove(userId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Login deleteLogin(Login login) throws SystemException {
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Login.class,
    ...
    @Override
    public Login fetchLogin(long userId) throws SystemException {
        return loginPersistence.fetchByPrimaryKey(userId);
    }
     ...
     */
    @Override
    public Login getLogin(long userId) throws PortalException, SystemException {
        return loginPersistence.findByPrimaryKey(userId);
    }
     ...
     */
    @Override
    public List<Login> getLogins(int start, int end) throws SystemException {
     ...
     */
    @Override
    public int getLoginsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Login updateLogin(Login login) throws SystemException {
        return loginPersistence.update(login);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.excilys.liferay.gatling.model.Login",
            loginLocalService);
    }
