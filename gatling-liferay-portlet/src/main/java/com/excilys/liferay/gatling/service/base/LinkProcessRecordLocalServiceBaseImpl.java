...
import com.excilys.liferay.gatling.service.LinkProcessRecordLocalService;
...
/**
 * Provides the base implementation for the link process record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.excilys.liferay.gatling.service.impl.LinkProcessRecordLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class LinkProcessRecordLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements LinkProcessRecordLocalService,
        IdentifiableBean {
    ...
    private LinkProcessRecordLocalServiceClpInvoker _clpInvoker = new LinkProcessRecordLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.excilys.liferay.gatling.service.LinkProcessRecordLocalServiceUtil} to access the link process record local service.
     */
    ...
    @Override
    public LinkProcessRecord addLinkProcessRecord(
        LinkProcessRecord linkProcessRecord) throws SystemException {
        linkProcessRecord.setNew(true);

        return linkProcessRecordPersistence.update(linkProcessRecord);
    }
     ...
     */
    @Override
    public LinkProcessRecord createLinkProcessRecord(
        long link_process_record_id) {
        return linkProcessRecordPersistence.create(link_process_record_id);
    }
    ...
    @Override
    public LinkProcessRecord deleteLinkProcessRecord(
        long link_process_record_id) throws PortalException, SystemException {
        return linkProcessRecordPersistence.remove(link_process_record_id);
    }
    ...
    public LinkProcessRecord deleteLinkProcessRecord(
        LinkProcessRecord linkProcessRecord) throws SystemException {
        return linkProcessRecordPersistence.remove(linkProcessRecord);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(LinkProcessRecord.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return linkProcessRecordPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return linkProcessRecordPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public LinkProcessRecord fetchLinkProcessRecord(long link_process_record_id)
        throws SystemException {
        return linkProcessRecordPersistence.fetchByPrimaryKey(link_process_record_id);
    }
     ...
     */
    @Override
    public LinkProcessRecord getLinkProcessRecord(long link_process_record_id)
        throws PortalException, SystemException {
        return linkProcessRecordPersistence.findByPrimaryKey(link_process_record_id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return linkProcessRecordPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<LinkProcessRecord> getLinkProcessRecords(int start, int end)
        throws SystemException {
        return linkProcessRecordPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getLinkProcessRecordsCount() throws SystemException {
        return linkProcessRecordPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public LinkProcessRecord updateLinkProcessRecord(
        LinkProcessRecord linkProcessRecord) throws SystemException {
        return linkProcessRecordPersistence.update(linkProcessRecord);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.excilys.liferay.gatling.model.LinkProcessRecord",
            linkProcessRecordLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = linkProcessRecordPersistence.getDataSource();
