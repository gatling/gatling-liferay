...
public class UrlSiteMapWrapper implements UrlSiteMap, ModelWrapper<UrlSiteMap> {
    ...
    */
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.excilys.liferay.gatling.model.UrlSiteMap> toCacheModel() {
        return _urlSiteMap.toCacheModel();
    }

    @Override
    public com.excilys.liferay.gatling.model.UrlSiteMap toEscapedModel() {
        return new UrlSiteMapWrapper(_urlSiteMap.toEscapedModel());
    }

    @Override
    public com.excilys.liferay.gatling.model.UrlSiteMap toUnescapedModel() {
