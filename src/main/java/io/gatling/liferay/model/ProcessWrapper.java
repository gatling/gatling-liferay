...
public class ProcessWrapper implements Process, ModelWrapper<Process> {
    ...
    */
    ...
    @Override
    public int compareTo(io.gatling.liferay.model.Process process) {
    ...
    @Override
    public io.gatling.liferay.model.Process toEscapedModel() {
        return new ProcessWrapper(_process.toEscapedModel());
    }

    @Override
    public io.gatling.liferay.model.Process toUnescapedModel() {
