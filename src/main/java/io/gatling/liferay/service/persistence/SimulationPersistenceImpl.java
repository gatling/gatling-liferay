...
import io.gatling.liferay.NoSuchSimulationException;
...
public class SimulationPersistenceImpl extends BasePersistenceImpl<Simulation>
    ...
    @Override
    public Simulation updateImpl(io.gatling.liferay.model.Simulation simulation)
        throws SystemException {
        simulation = toUnwrappedModel(simulation);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.io.gatling.liferay.model.Simulation")));
