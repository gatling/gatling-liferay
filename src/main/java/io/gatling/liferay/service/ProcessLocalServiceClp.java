 ...
 * @generated
 */
public class ProcessLocalServiceClp implements ProcessLocalService {
    ...
    public io.gatling.liferay.model.Process addProcess(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(process) });
        } catch (Throwable t) {
        ...
        return (io.gatling.liferay.model.Process) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public io.gatling.liferay.model.Process createProcess(long process_id) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { process_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public io.gatling.liferay.model.Process deleteProcess(long process_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { process_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public io.gatling.liferay.model.Process fetchProcess(long process_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { process_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public io.gatling.liferay.model.Process getProcess(long process_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { process_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<io.gatling.liferay.model.Process> getProcesses(
        ...
        return (java.util.List<io.gatling.liferay.model.Process>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int findPause(long scenarioId, long processesId, int order)
        ...
        try {
            ...
            if (t instanceof io.gatling.liferay.NoSuchProcessScenarioLinkException) {
                throw (io.gatling.liferay.NoSuchProcessScenarioLinkException) t;
            }
